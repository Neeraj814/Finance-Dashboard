      ...
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-lg bg-sidebar-accent flex items-center justify-center">
            <span className="text-sidebar-accent-foreground font-bold text-sm">F</span>
          </div>
          {!collapsed && <span className="font-bold text-sidebar-primary text-lg tracking-tight">FinDash</span>}
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarGroup>
